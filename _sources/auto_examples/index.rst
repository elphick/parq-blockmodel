...
These scripts power the Sphinx Gallery published in the docs.

They broadly align to a validate → review (profile) → view workflow:

* validate: schema-backed loading and validation examples
* review: reporting/profiling examples (including schema-enriched descriptions)
* view: PyVista and Trame visualization examples
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="This example demonstrates how Pandera schema column title and description metadata improve the variable descriptions shown in create_report output.">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_18_profile_report_with_schema_descriptions_thumb.png
    :alt:

  :doc:`/auto_examples/18_profile_report_with_schema_descriptions`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Profile Reports with Schema Descriptions</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="This example demonstrates precedence-aware categorical footprint mapping from a parq_blockmodel.blockmodel.ParquetBlockModel.">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_19_categorical_footprint_mapping_thumb.png
    :alt:

  :doc:`/auto_examples/19_categorical_footprint_mapping`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Categorical Footprint Mapping</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="This example demonstrates dense and sparse plan-view footprint extraction from a parq_blockmodel.blockmodel.ParquetBlockModel.">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_20_dense_sparse_footprint_mapping_thumb.png
    :alt:

  :doc:`/auto_examples/20_dense_sparse_footprint_mapping`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Dense and Sparse Footprint Mapping</div>
    </div>
...
.. toctree::
   ...
   /auto_examples/18_profile_report_with_schema_descriptions
   /auto_examples/19_categorical_footprint_mapping
   /auto_examples/20_dense_sparse_footprint_mapping
