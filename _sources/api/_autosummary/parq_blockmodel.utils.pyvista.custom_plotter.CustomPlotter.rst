...
.. autoclass:: CustomPlotter
   ...
   .. autosummary::
      ...
      ~CustomPlotter.enable_interactor_style
      ...
      ~CustomPlotter.setup_picking_with_callback
      ~CustomPlotter.show
   ...
   .. autosummary::
      ...
      ~CustomPlotter.box_clipped_meshes
      ~CustomPlotter.box_widgets
      ~CustomPlotter.button_widgets
      ~CustomPlotter.camera
      ~CustomPlotter.camera3d_widgets
      ~CustomPlotter.camera_position
      ~CustomPlotter.camera_set
      ~CustomPlotter.camera_widgets
      ~CustomPlotter.center
      ~CustomPlotter.click_position
      ~CustomPlotter.distance_widgets
      ~CustomPlotter.image
      ~CustomPlotter.image_depth
      ~CustomPlotter.image_scale
      ~CustomPlotter.isovalue_meshes
      ~CustomPlotter.last_update_time
      ~CustomPlotter.legend
      ~CustomPlotter.length
      ~CustomPlotter.line_widgets
      ~CustomPlotter.logo_widgets
      ...
      ~CustomPlotter.picked_geodesic
      ~CustomPlotter.picked_horizon
      ~CustomPlotter.picked_mesh
      ~CustomPlotter.picked_path
      ~CustomPlotter.picked_point
      ~CustomPlotter.plane_clipped_meshes
      ~CustomPlotter.plane_sliced_meshes
      ~CustomPlotter.plane_widgets
      ~CustomPlotter.radio_button_title_dict
      ~CustomPlotter.radio_button_widget_dict
      ~CustomPlotter.render_window
      ~CustomPlotter.renderer
      ~CustomPlotter.scalar_bar
      ~CustomPlotter.scale
      ~CustomPlotter.shape
      ~CustomPlotter.slider_widgets
      ~CustomPlotter.sphere_widgets
      ~CustomPlotter.spline_sliced_meshes
      ~CustomPlotter.spline_widgets
      ~CustomPlotter.suppress_rendering
      ~CustomPlotter.theme
      ~CustomPlotter.threshold_meshes
